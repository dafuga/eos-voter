...
class ProducersTableRow extends Component<Props> {
  ...
  render() {
    ...
    const voteFormatted = (producer.votes > 0)
      ...
      : 'None';
    const shouldDisplayInfoButton = connection && connection.supportedContracts.includes('producerinfo');
    return (
      <Table.Row positive={isActive} key={producer.key}>
        ...
        >
          ...
          <Popup
            content={t('producer_vote_description', { chainSymbol: connection && connection.chainSymbol })}
